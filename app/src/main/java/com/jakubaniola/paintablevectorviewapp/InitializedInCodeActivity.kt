...
import kotlinx.android.synthetic.main.activity_initialized_in_code.*
import kotlinx.android.synthetic.main.activity_main.*

class InitializedInCodeActivity : AppCompatActivity() {

    private lateinit var paintableView: PaintableVectorView

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_initialized_in_code)
    }
